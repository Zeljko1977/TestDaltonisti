              ...
              <Card>
                <Card.Body>
                  <p>
                    ...
                    <br />
                    Između 5 i 10% ljudi ima neke poteškoće sa razlikovanjem
                    boja i mi, istraživači sa Filozofskog fakulteta i Fakulteta
                    tehničkih nauka u Novom Sadu, sada sprovodimo istraživanje o
                    viđenju i pamćenju boja. Nadamo se da će nam dobijeni
                    rezultati pomoći da dalje razvijemo tehnologije za
                    optimizaciju slike na različitim uređajima (mobilni
                    telefoni, tableti, televizori, računar) tako da olakšamo
                    njihovo korišćenje ljudima sa poteškoćama u opažanju boja.
                    <br />
                    <br />
                    Da bi razumeli opažaje, pamćenje i usmeravaje pažnje na boje
                    potrebni su nam podaci od dobrovoljaca poput Vas.
                    <br />
                    Dakle, ako pristanete da nam pomognete, Vaše učešće
                    istraživanju je dobrovoljno i potpuno anonimno. Vaši podaci
                    će biti korišćeni isključivo u naučne svrhe i niko sa strane
                    neće moći da uspostavi vezu između Vas lično i Vaših
                    odgovora u istraživanju.
                    <br />
                    Ukoliko na kraju i poželite da nas lično kontaktirate i time
                    nam otkrijete svoj identitet, mi ga i dalje nećemo nikom
                    drugom otkriti, odnosno Vaše ime i prezime nikada neće biti
                    navedeno u izveštaju o rezultatima niti i u jednoj
                    publikaciji rezultata. Izveštaji o rezultatima sadržaće samo
                    informacije za cele grupe ispitanika, nikako Vaše
                    individualne rezultate.
                    <br />
                    U prvom koraku istraživanja, bićete zamoljeni da uradite
                    kratak test opažanja boja koji pokazuje da li imate nekih
                    poteškoća u razlikovanju boja. Nakon toga, bićete zamoljeni
                    da odgovorite na nekoliko opštih pitanja (vaš pol, uzrast,
                    zanimanje, da li ste ranije imali poteškoća sa razlikovanjem
                    boja). Nakon toga, bićete zamoljeni da uradite nekoliko
                    zadataka u kojima će vam biti prikazivani obojeni objekti, a
                    vaš zadatak će biti ili da zapamtite boju objekta ili da
                    prepoznate objekte koji su iste boje.
                    <br />
                    <br />
                    Većina ispitanika sve ovo završi za oko 25 minuta.
                    <br />
                    <br />
                    Ukoliko želite da nastavite sa učešćem u ovom istraživanju,
                    kliknite DALJE da pročitate Saglasnost za učestvovanje u
                    istraživanju.
                  </p>
                </Card.Body>
              </Card>
            ...
            {jezik == 1 && start2 && (
              <Card>
                <Card.Body>
                  <p>
                    {' '}
                    <b>SAGLASNOST ZA UČESTVOVANJE U ISTRAŽIVANJU</b> <br />
                    <br />
                    Ovim potvrđujem da sam saglasan/na da učestvujem u
                    istraživanju o prepoznavanju i pamćenju boja. Potvrđujem da
                    mi je objašnjeno šta se od mene zahteva u istraživanju.
                    <br />
                    Shvatam da učestvovanje u ovom istraživanju ni na koji način
                    neće da mi nanese štetu, da bude ugrožavajuće, da me izloži
                    neprijatnostima, niti će se tokom eksperimenta koristiti
                    tehnike obmanjivanja. Ipak, ako nisam zadovoljan/na
                    tretmanom, u svakom trenutku mogu da prekinem istraživanje
                    bez objašnjenja. Objašnjeno mi je da će moji podaci biti
                    korišćeni isključivo u naučne svrhe te da niko sa strane
                    neće moći da uspostavi vezu između mene lično i mog
                    postignuća u eksperimentu. Dodatno se o učestvovanju u
                    istraživanju mogu informisati kod istraživača putem imejla:
                    <br />
                    ...
                    <br />
                    <br />
                    Klikom na polje <b>"SLAŽEM SE"</b> potvrđujete da ste
                    pročitali i u potpunosti razumeli gore navedene informacije
                    i da prihvatate učešće u istraživanju. Za nastavak kliknite
                    na dugme <b>ZAPOČNITE EKSPERIMENT</b>.
                  </p>
                </Card.Body>
              </Card>
            )}
            ...
            <Row>
              ...
              <Col xs={2}>
                <Form.Group className='mb-3' controlId='formBasicCheckbox'>
                  <Form.Check
                    type='checkbox'
                    label={jezik == 1 ? 'Slažem se' : 'I agree'}
          ...
          {start && (
            <div>
                ...
                <Card>
                  <Card.Body>
                    <p>
                      ...
                      opažanja boja koji traje okvirno do 5 minuta. Test koji
                      pripada Enchroma sajtu će se otvoriti u novom tabu
                      (prozoru) nakon što kliknete na dugme{' '}
                      ...
                      NAPOMENA: Ne zatvarajte ovaj tekući prozor jer ćete se
                      vratiti na njega kada završite sa testom. Pre početka
                      testa pojačajte svetlinu (brightness) ekrana na maksimalni
                      intezitet. Uradite test do kraja i kao finalni korak
                      kliknite na link{' '}
                      <b>"No, thanks. Continue to the test result."</b> (videti
                      sliku ispod) i dobićete rezultate testa u kojima će biti
                      sadržane dve informacije – koju vrstu poremećaja imate
                      (protan, deutan, tritan) i u kom stepenu je izražen
                      poremećaj (mild, moderate, severe). Moguće je i da kao
                      rezultat dobijete kategoriju „normalno opažanje boja“.
                      Zapamtite rezultat i vratite se u ovaj prozor da odaberete
                      kategoriju dobijenog rezultata i pređete na sledeći korak
                      ispitivanja. Ako dobijete rezultat testa
                      "Neodređen/nepotpun rezultat" ponovite test sve dok ne
                      dobijete jednu od ponuđenih 10 kategorija.
                    </p>
                  </Card.Body>
                </Card>
              )}
              ...
              <Row>
                <Form.Label>
                  {jezik == 1
                    ? 'Izaberite kategoriju Vašeg poremećaja vida'
                ...
                <div>
                  ...
                  <Row>
                    ...
                    <div key={`inline-radio`} className='mb-3'>
                      ...
                      <Form.Check
                        ...
                        type='radio'
                        id='default-checkbox1'
                        label={jezik == 1 ? 'Nešto drugo' : 'Something else'}
                  ...
                  {jezik == 1 && (
                    <Card>
                      <Card.Body>
                        <p>
                          Vaši podaci su nam dragoceni u razumevanju procesa
                          viđenja i pamćenja boja kao i pri razvijanju tehničkih
                          pomagala za ljude sa teškoćama u razlikovanju boja.
                          Ukoliko imate poteškoća u razlikovanju boja, bili
                          bismo Vam veoma zahvalni ukoliko biste želeli da
                          učestvujete i u nekom od naših narednih istraživanja
                          na ovu temu. Ukoliko je to slučaj, molimo Vas da
                          unesete svoju imejl adresu preko koje možemo da Vas
                          kontaktiramo. Čak i ako sada ostavite adresu uvek
                          kasnije možete da se predomislite i da odbijete dalje
                          učešće.
                        </p>
                        <p>
                          Poslaćemo Vam ličnu šifru za učešće u narednom
                          istraživanju, te Vas molimo da je sačuvate. Ukoliko
                          imate bilo kakvih pitanja, komentara ili želite da
                          podelite utiske o učešću u istraživanju, budite
                  ...
                  <Row>
                    <Form.Label>
                      {jezik == 1
                        ? 'Da li Ste ikada bili dijagnostikovani kao osoba sa teškoćama u prepoznavanju boja?'
                    ...
                    <div>
                      <Row>
                        <Form.Group as={Col} controlId='formGridPassword'>
                          ...
                          <Form.Control
                            ...
                            placeholder={
                              jezik == 1
                                ? 'upišite godinu ili period Vašeg života, kao na pr. kasno detinjstvo'
                      ...
                      <Row>
                        <Form.Group as={Col} controlId='formGridPassword'>
                          ...
                          <Form.Control
                            ...
                            placeholder={
                              jezik == 1
                                ? 'upišite najpreciznije što možete'
                      ...
                      <Row>
                        <Form.Group as={Col} controlId='formGridPassword'>
                          <Form.Label>
                            {jezik == 1
                              ? 'Kad ste prvi put primetili probleme u opažanju boja? Možete li opisati tu situaciju kao i kad se desila?'
                      ...
                      <Row>
                        <Form.Group as={Col} controlId='formGridPassword'>
                          <Form.Label>
                            {jezik == 1
                              ? 'Da li danas postoji neka situacija u kojoj Vas naročito ometa vaša percepcija boja?'
      ...
      {start && startQuestionnaire && (
        <Row>
          ...
          <Col xs={3}>
            ...
            >
              {jezik == 1
                ? 'Sačuvajte i pređite na test'.toUpperCase()
